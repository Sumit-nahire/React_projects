...
function App() {
  ...
  <h1 className='text-white text-2xl text-center py-4 font-bold'>
    Password Generator
  </h1>
        <div className='flex shadow rounded-lg overflow-hidden mb-4'>
          ...
          onClick={copyPasswordToClipboard}
           className='outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0 hover:bg-blue-600 transition-colors duration-300'>
            Copy
          </button>
        </div>
          ...
          <div className='flex items-center gap-x-1'>
           ...
           <div className='flex items-center gap-x-1'>
            <input
              ...
              onChange={() =>{ setCharterAllowed((prev)=> !prev);
